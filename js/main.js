...
let shoeMobileBtn = document.querySelector(".shoe");
...
const closeMenu = (event) => {
  ...
  navbar.classList.remove("is-open"); // Добавляем класс к меню
...
shoeMobileBtn.addEventListener("click", () => {
  shoeList.classList.toggle("is-open");
});
console.log(shoeMobileBtn);
